...
const LogoHeader = () => (
  <Section style={styles.logoSection}>
    <Img src={LOGO_URL} alt="Brown Hat Academy" width={160} style={styles.logo} />
  </Section>
);
    ...
    <Body style={styles.main}>
      <Container style={styles.container}>
        ...
        <Section style={styles.body}>
          <Heading style={styles.h1}>Welcome to Brown Hat Academy!</Heading>
          ...
          <Text style={styles.footer}>If you didn't create an account, you can safely ignore this email.</Text>
        </Section>
      </Container>
    </Body>
  </Html>
    ...
    <Body style={styles.main}>
      <Container style={styles.container}>
        ...
        <Section style={styles.body}>
          ...
          <Text style={styles.footer}>If you weren't expecting this, you can safely ignore this email.</Text>
        </Section>
      </Container>
    </Body>
  </Html>
    ...
    <Body style={styles.main}>
      <Container style={styles.container}>
        ...
        <Section style={styles.body}>
          ...
          <Text style={styles.text}>Click the button below to confirm:</Text>
          <Button style={styles.button} href={confirmationUrl}>
            Confirm Email Change
          </Button>
          <Text style={styles.footer}>If you didn't request this, please secure your account immediately.</Text>
        </Section>
      </Container>
    </Body>
  </Html>
